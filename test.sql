...
CREATE TABLE `plan_region_config` (
  ...
  `region_count` bigint(20)  DEFAULT NULL COMMENT '当前`数量',
  `region_total` bigint(20) NOT NULL COMMENT '总数',
  ...
  KEY `idx_limit_type` (`limit_type`) USING BTREE
